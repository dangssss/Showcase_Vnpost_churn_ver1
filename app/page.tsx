...
const actionStages = [
  ...
  },
  {
    ...
    description:
      "The CRM contract records outreach channel, contact time and the staff member who completed the interaction.",
  },
  {
  ...
  return (
    <main>
        ...
        <div className="section-intro split-intro">
          ...
          <div>
            <p>
              ...
              first, why are they at risk, and how does the list fit real intervention capacity? The operating system is
              built around that decision — and the public demo reproduces its full path from raw monthly data to a ranked queue.
            </p>
      ...
      <section className="section production-design" id="production-design">
        ...
        <div className="section-intro method-intro">
          <div>
            <p className="eyebrow mint"><span /> Operational workflow · system-aligned</p>
            <h2>
          ...
          <p>
            This is the operating layer around the model: structured reasons generated by the production pipeline, a
            controlled human handoff and a CRM-ready action contract. The public notebook proves the model path; this
            layer shows how the accepted score is worked, audited and returned as an outcome.
          </p>
        </div>
        ...
        <div className="design-grid">
          ...
          <article className="design-card action-card">
            <span className="card-kicker mint">HUMAN WORKFLOW · OPERATING CONTRACT</span>
            ...
            <div className="workflow-status" aria-live="polite">
              <div>
                <span>WORKFLOW STATE PREVIEW</span>
                <code>action_status = {currentStage.status}</code>
              </div>
              <strong>{currentStage.label}</strong>
              <p>{currentStage.description}</p>
              <small>
                CRM field: <code>{currentStage.eventField}</code> · This interactive preview does not write to an external system.
              </small>
            </div>
          </article>
          ...
          <article className="design-card contract-card">
            ...
            <h3>How the operating contract is layered</h3>
            <div className="contract-layers">
              ...
              <div>
                <b>CRM action &amp; feedback contract</b>
                <p>Standardizes the handoff and closes the two-month outcome loop without changing the model score.</p>
                <code>case_id · action_owner · action_status · contacted_at · outcome · retained_after_horizon</code>
              </div>
            </div>
          </article>
        </div>
